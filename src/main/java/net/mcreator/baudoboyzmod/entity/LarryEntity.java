...
public class LarryEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BaudoBoyzModModEntities.LARRY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
