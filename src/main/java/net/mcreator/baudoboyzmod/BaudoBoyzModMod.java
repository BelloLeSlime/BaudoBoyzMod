package net.mcreator.baudoboyzmod;
...
@Mod("baudo_boyz_mod")
public class BaudoBoyzModMod {
	public static final Logger LOGGER = LogManager.getLogger(BaudoBoyzModMod.class);
	public static final String MODID = "baudo_boyz_mod";

	public BaudoBoyzModMod(IEventBus modEventBus) {
